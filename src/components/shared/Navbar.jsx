    ...
    <div className={`fixed top-0 lg:px-[90px] w-full z-50 ${isScrolled  ? "bg-white" : "bg-transparent"}`}>
      <div className="navbar">
        ...
        <div className="navbar-end">
          <div className="hidden sm:flex justify-center gap-3 font-medium text-base text-gray-300 pr-5">
            {/* Favorites */}
          ...
          <div className="relative">
            <button
              ...
              className="btn btn-outline md:px-7 px-5 border-gray-300 text-gray-300"
...

{
  isDropdownOpen2 && (
    ...
    >
      ...
      {/* Register Form */}
        <RegisterPage isDropdownOpen2={isDropdownOpen2}></RegisterPage>
    </div>
  </>
  )
}
